...
// OAuth constants are intentionally supplied by the operator at runtime.
// Do not commit provider-issued OAuth client credentials to the repository.
...
function assertOAuthConfigured(): void {
  if (!CLIENT_ID || !CLIENT_SECRET) {
    throw new Error(
      "Google Antigravity OAuth requires GOOGLE_ANTIGRAVITY_CLIENT_ID and " +
        "GOOGLE_ANTIGRAVITY_CLIENT_SECRET environment variables.",
    );
  }
}
