...
import type { LogsTailParams } from "./rpc-params.js";
...
const logsDescriptors = defineHandlers({
  "logs.tail": {
    scope: "read",
    handler: async ({ params, respond }) => {
      ...
      const p = params as LogsTailParams;
...
registryRegister(logsDescriptors);
export const logsHandlers = toHandlerMap(logsDescriptors);
