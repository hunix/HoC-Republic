import type { UpdateInstallParams } from "./rpc-params.js";
...
export const updateHandlers: GatewayRequestHandlers = {
  "update.run": async ({ params, respond }) => {
    ...
    const p = params as UpdateInstallParams;
    const sessionKey =
      typeof p.sessionKey === "string" ? p.sessionKey.trim() || undefined : undefined;
    const note = typeof p.note === "string" ? p.note.trim() || undefined : undefined;
    const restartDelayMsRaw = p.restartDelayMs;
