import type { DevicePairApproveParams, DeviceTokenParams } from "./rpc-params.js";
...
export const deviceHandlers: GatewayRequestHandlers = {
  ...
  "device.pair.approve": async ({ params, respond, context }) => {
    ...
    const { requestId } = params as DevicePairApproveParams;
  ...
  "device.token.rotate": async ({ params, respond, context }) => {
    ...
    const { deviceId, role, scopes } = params as DeviceTokenParams;
  ...
  "device.token.revoke": async ({ params, respond, context }) => {
    ...
    const { deviceId, role } = params as DeviceTokenParams;
