...
import type { ExecApprovalRequestParams, ExecApprovalResolveParams } from "./rpc-params.js";
...
export function createExecApprovalHandlers(
  ...
  return {
    "exec.approval.request": async ({ params, respond, context }) => {
      ...
      const p = params as ExecApprovalRequestParams;
    ...
    "exec.approval.resolve": async ({ params, respond, client, context }) => {
      ...
      const p = params as ExecApprovalResolveParams;
