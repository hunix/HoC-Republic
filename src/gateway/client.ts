...
import { WebSocket, type CertMeta, type ClientOptions } from "ws";
import {
...
import {
    PROTOCOL_VERSION, validateEventFrame,
    validateRequestFrame,
    validateResponseFrame, type ConnectParams,
    type EventFrame,
    type HelloOk, type RequestFrame
