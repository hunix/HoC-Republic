...
export function createGatewayCloseHandler(params: {
  ...
  missionControl: { stop: () => Promise<void> } | null;
  wss: WebSocketServer;
  ...
  return async (opts?: { reason?: string; restartExpectedMs?: number | null }) => {
    ...
    if (params.tailscaleCleanup) {
      try {
        ...
        /* tailscale cleanup is non-critical, don't block shutdown */
      }
    }
    ...
    if (params.missionControl) {
      await params.missionControl.stop().catch(() => {});
    }
