...
export function startGatewayMaintenanceTimers(params: {
  ...
  // NOTE: do NOT call tickInterval.unref() — this is the primary ref'd timer that keeps
  // the event loop alive. Unref'd timers cannot prevent process exit (Node.js event-loop drain).
