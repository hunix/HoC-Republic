...
export function resolveOpenClawMetadata(
  ...
  try {
    ...
    return {
      ...
      input_schema:
        typeof metadataObj.input_schema === "object"
          ? (metadataObj.input_schema as Record<string, unknown>)
          : undefined,
      output_schema:
        typeof metadataObj.output_schema === "object"
          ? (metadataObj.output_schema as Record<string, unknown>)
          : undefined,
    };
  } catch {
    return undefined;
