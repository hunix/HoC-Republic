...
import { DEFAULT_FALLBACKS, DEFAULT_MODEL, DEFAULT_PROVIDER } from "./defaults.js";
import {
...
function resolveFallbackCandidates(params: {
  ...
  const modelFallbacks = (() => {
    ...
    if (model && typeof model === "object") {
      // Respect explicit empty array (user said "no fallbacks").
      // Only inject defaults when fallbacks key is absent / undefined.
      return model.fallbacks ?? [...DEFAULT_FALLBACKS];
    }
