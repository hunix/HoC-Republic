...
export {
    ...
    classifyFailoverReason, formatAssistantErrorText, formatRawAssistantErrorForUi, getApiErrorPayloadFingerprint,
    isAuthAssistantError,
    isAuthErrorMessage,
    isBillingAssistantError, isBillingErrorMessage,
    isCloudCodeAssistFormatError,
    isCompactionFailureError,
    isContextOverflowError, isFailoverAssistantError,
    isFailoverErrorMessage,
    isImageDimensionErrorMessage,
    isImageSizeError, isLikelyContextOverflowError, isOverloadedErrorMessage, isRateLimitAssistantError,
    isRateLimitErrorMessage, isRawApiErrorPayload, isTimeoutErrorMessage, parseApiErrorInfo, parseImageDimensionError,
    parseImageSizeError, sanitizeUserFacingText
