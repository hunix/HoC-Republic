...
import { loadConfig as loadConfigStatic, type OpenClawConfig } from "../../config/config.js";
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "agent-mode",
    description: "Lightweight agent gateway (chat + tools only)",
    register: async (program) => {
      const mod = await import("../agent-mode-cli.js");
      mod.registerAgentModeCli(program);
    },
  },
  {
    name: "sandbox",
