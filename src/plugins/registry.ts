...
import type {
    ...
    OpenClawPluginCommandDefinition, OpenClawPluginHookOptions, OpenClawPluginHttpHandler,
    OpenClawPluginHttpRouteHandler, OpenClawPluginService,
    OpenClawPluginToolContext,
    OpenClawPluginToolFactory,
    PluginConfigUiHint,
    PluginDiagnostic, PluginHookHandlerMap, PluginHookName, PluginHookRegistration as TypedPluginHookRegistration, PluginKind, PluginLogger,
    PluginOrigin, ProviderPlugin
} from "./types.js";
