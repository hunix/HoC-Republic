...
import {
    ...
    resolveModelRefFromString, type ModelAliasIndex
...
import {
    formatAuthLabel, resolveAuthLabel,
    resolveProfileOverride, type ModelAuthDetailMode
} from "./directive-handling.auth.js";
import {
    resolveProviderEndpointLabel, type ModelPickerCatalogEntry
