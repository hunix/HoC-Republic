...
import {
    ...
    applyCloudflareAiGatewayConfig, applyKimiCodeConfig,
    applyMinimaxApiConfig,
    applyMinimaxConfig,
    applyMoonshotConfig,
    applyMoonshotConfigCn,
    applyOpencodeZenConfig,
    applyOpenrouterConfig, applyQianfanConfig, applySyntheticConfig,
    applyVeniceConfig,
    ...
    setOpenrouterApiKey, setQianfanApiKey, setSyntheticApiKey, setVeniceApiKey,
