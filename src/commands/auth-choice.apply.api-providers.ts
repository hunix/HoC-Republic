...
import {
    ...
    applyZaiConfig,
    CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, KIMI_CODING_MODEL_REF,
    MOONSHOT_DEFAULT_MODEL_REF,
    OPENROUTER_DEFAULT_MODEL_REF, QIANFAN_DEFAULT_MODEL_REF, setCloudflareAiGatewayConfig, setGeminiApiKey,
    setKimiCodingApiKey,
    setMoonshotApiKey,
    ...
    setXiaomiApiKey,
    setZaiApiKey, SYNTHETIC_DEFAULT_MODEL_REF,
    VENICE_DEFAULT_MODEL_REF,
    VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF,
    XIAOMI_DEFAULT_MODEL_REF, ZAI_DEFAULT_MODEL_REF
