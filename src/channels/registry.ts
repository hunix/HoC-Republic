...
const CHAT_CHANNEL_META: Record<ChatChannelId, ChannelMeta> = {
  ...
  msteams: {
    ...
    detailLabel: "MS Teams Bot",
    docsPath: "/channels/msteams",
    docsLabel: "msteams",
    blurb: "Azure Bot Framework integration for Microsoft Teams.",
    systemImage: "person.3",
  },
  sms: {
    id: "sms",
    label: "SMS",
    selectionLabel: "SMS (Twilio / Vonage)",
    detailLabel: "SMS Gateway",
    docsPath: "/channels/sms",
    docsLabel: "sms",
    blurb: "send and receive SMS via Twilio, Vonage, or Windows Companion.",
    systemImage: "phone.bubble",
  },
  email: {
    id: "email",
    label: "Email",
    selectionLabel: "Email (IMAP / Graph / Gmail)",
    detailLabel: "Email",
    docsPath: "/channels/email",
    docsLabel: "email",
    blurb: "inbound/outbound email via IMAP, Microsoft Graph, or Gmail API.",
    systemImage: "envelope",
  },
  googlemeet: {
    id: "googlemeet",
    label: "Google Meet",
    selectionLabel: "Google Meet (Calendar + Transcription)",
    detailLabel: "Google Meet",
    docsPath: "/channels/googlemeet",
    docsLabel: "googlemeet",
    blurb: "auto-join meetings, transcribe, and respond in chat or via TTS.",
    systemImage: "video",
  },
};
