...
import {
    ...
    GATEWAY_SERVICE_MARKER, NODE_SERVICE_KIND,
    NODE_SERVICE_MARKER,
    NODE_WINDOWS_TASK_SCRIPT_NAME, resolveGatewayLaunchAgentLabel,
    resolveGatewaySystemdServiceName, resolveNodeLaunchAgentLabel,
