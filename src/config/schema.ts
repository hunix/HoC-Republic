...
const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.supabase.url": "Supabase Project URL",
  "gateway.supabase.anonKey": "Supabase Anon Key",
  "gateway.supabase.serviceRoleKey": "Supabase Service Role Key",
};
...
const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.supabase.url":
    "Supabase project URL (e.g. https://xxx.supabase.co). Enables cloud persistence for Republic data.",
  "gateway.supabase.anonKey":
    "Supabase anon/public key. Used for client-side queries with RLS enforcement.",
  "gateway.supabase.serviceRoleKey":
    "Supabase service role key. Bypasses RLS for server-side admin operations. Keep secret.",
};
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.supabase.url": "https://xxx.supabase.co",
  "gateway.supabase.anonKey": "eyJhbGciOiJIUzI1NiIs…",
  "gateway.supabase.serviceRoleKey": "eyJhbGciOiJIUzI1NiIs…",
};
