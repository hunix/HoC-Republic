...
import { usageStylesString } from "./usage-styles.ts";
  ...
  return html`
    <div class="active-filters">
        ...
        selectedDays.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button type="button" class="filter-chip-remove" @click=${onClearDays} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedHours.length > 0
          ? html`
            <div class="filter-chip">
              ...
              <button type="button" class="filter-chip-remove" @click=${onClearHours} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
        ...
        selectedSessions.length > 0
          ? html`
            <div class="filter-chip" title="${sessionsFullName}">
              ...
              <button type="button" class="filter-chip-remove" @click=${onClearSessions} title="Remove filter">×</button>
            </div>
          `
          : nothing
      }
      ${
        (selectedDays.length > 0 || selectedHours.length > 0) && selectedSessions.length > 0
          ? html`
            <button type="button" class="btn btn-sm filter-clear-btn" @click=${onClearFilters}>
              Clear All
            </button>
          `
          : nothing
    ...
    <div class="card sessions-card">
      ...
      <div class="sessions-card-meta">
        ...
        ${
          selectedCount > 0
            ? html`
                <button type="button" class="btn btn-sm sessions-action-btn sessions-clear-btn" @click=${onClearSessions}>
                  Clear Selection
                </button>
              `
            : nothing
  ...
  return html`
    <div class="card session-detail-panel">
      <div class="session-detail-header">
        ...
        <button type="button" class="session-close-btn" @click=${onClose} title="Close session details">×</button>
      </div>
  ...
  return html`
    <div class="context-details-panel">
      <div class="context-breakdown-header">
        ...
        ${
          hasMore
            ? html`<button type="button" class="context-expand-btn" @click=${onToggleExpanded}>
  ...
  return html`
    <div class="session-logs-compact">
      <div class="session-logs-header">
        ...
        <button type="button" class="btn btn-sm usage-action-btn usage-secondary-btn" @click=${onToggleExpandedAll}>
      ...
      <div class="usage-filters-inline" style="margin: 10px 12px;">
        ...
        />
        <button type="button" class="btn btn-sm usage-action-btn usage-secondary-btn" @click=${onFilterClear}>
          Clear
        </button>
      </div>
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button type="button"
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `hoc-usage-sessions-${exportStamp}.csv`,
                ...
                <button type="button"
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `hoc-usage-daily-${exportStamp}.csv`,
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ...
          <div class="usage-presets">
            ${datePresets.map(
              (preset) => html`
                <button type="button" class="btn btn-sm" @click=${() => applyPreset(preset.days)}>
                  ${preset.label}
                </button>
              `,
            )}
          ...
          <div class="usage-query-actions">
            ...
            ${
              hasDraftQuery || hasQuery
                ? html`<button type="button" class="btn btn-sm usage-action-btn usage-secondary-btn" @click=${props.onClearQuery}>Clear</button>`
                : nothing
            }
