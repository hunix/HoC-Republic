/**
 * Agents View — Helper Functions & Constants
 * Extracted from agents.ts to reduce file size.
 */

import { html } from "lit";
import type { AgentsListResult, AgentIdentityResult, AgentsFilesListResult } from "../types.ts";
import {
  expandToolGroups,
  normalizeToolName,
...
// Re-export the top-level types for use by agents.ts render functions
export type { AgentsListResult, AgentIdentityResult };
...
export const TOOL_SECTIONS = [
  ...
  },
  {
    ...
    label: "AGI Engines",
    tools: [
      { id: "llm_model_load", label: "llm_model_load", description: "Load LLM/GGUF models" },
      { id: "llm_model_unload", label: "llm_model_unload", description: "Unload models" },
      { id: "machine_learning_classify", label: "machine_learning_classify", description: "ML Classification" },
      { id: "machine_learning_predict", label: "machine_learning_predict", description: "ML Prediction" },
      { id: "machine_learning_anomaly", label: "machine_learning_anomaly", description: "ML Anomaly Detection" },
    ],
  },
  {
    id: "agi_memory",
    label: "AGI Memory",
    tools: [
      { id: "memory_chain_of_thought", label: "memory_chain_of_thought", description: "Step-by-step reasoning tree" },
      { id: "memory_tree_of_thought", label: "memory_tree_of_thought", description: "Branching multi-path evaluation" },
    ],
  },
  {
    id: "agi_expansion",
    label: "AGI Expansion",
    tools: [
      { id: "self_replicate_node", label: "self_replicate_node", description: "Clone Node" },
      { id: "self_replicate_cluster", label: "self_replicate_cluster", description: "Clone Cluster Segment" },
      { id: "skill_forge_create", label: "skill_forge_create", description: "Generate new Skills" },
      { id: "skill_forge_deploy", label: "skill_forge_deploy", description: "Deploy forged Skills" },
    ],
  },
  {
    id: "agi_civilization",
    label: "AGI Civilization",
    tools: [
      { id: "citizen_broadcast_awareness", label: "citizen_broadcast_awareness", description: "Broadcast simulation awareness" },
      { id: "civilization_sync_state", label: "civilization_sync_state", description: "Sync global knowledge" },
    ],
  },
];
...
export function matchesAny(name: string, patterns: CompiledPattern[]) {
