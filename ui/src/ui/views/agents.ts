    ...
    <section class="grid grid-cols-2">
      ...
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          ...
          <button type="button" class="btn btn--sm" ?disabled=${params.loading} @click=${params.onRefresh}>
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="row" style="gap: 8px;">
          <button type="button" class="btn btn--sm" ?disabled=${!editable} @click=${() => params.onClear(params.agentId)}>
            Use All
          </button>
          <button type="button" class="btn btn--sm" ?disabled=${!editable} @click=${() => params.onDisableAll(params.agentId)}>
            Disable All
          </button>
          <button type="button"
            class="btn btn--sm"
