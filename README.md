...
# Run the gateway without external channels for local development.
pnpm gateway:dev
...
After startup, open the local control surface at `http://localhost:18789`, unless you configured a different gateway port.

## Common workflows

| Goal | Command |
| --- | --- |
| Run the gateway in development mode | `pnpm gateway:dev` |
